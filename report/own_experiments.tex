...
- fill the noun verb matrix with probabilities for co-occurence in
...
(Count('company and produce co-occur') + Count('company and produces co-occur'))
Remark: this can be thought of as a language model
that take co-occurrence between noun and verb
as an measure to predict probabilities for next verb number.
...
HOW TO FIND CO-OCCURRENCE RATIOS IN TRAINING
\begin{itemize}
