...
- fill the noun verb matrix with counts for co-occurence in
sentences of the training corpus (noun before verb).
That is a training sentence like "company ... produce .. "
adds one to the entry at row 'company' and column 'produce'.
We can again normalize and rescale the numbers so that
they are between 0 and zero and plot as an image. 
